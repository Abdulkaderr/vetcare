...
class Patient_model extends CI_model {
    ...
    //new query for owner pets
    function getOwnerPatientWithoutSearch($order, $dir,$owner_id) {
        if ($order != null) {
            $this->db->order_by($order, $dir);
        } else {
            $this->db->order_by('id', 'desc');
    ...
    //specific owner pets
    function getOwnerPatientBySearch($search, $order, $dir, $owner_id) {
        if ($order != null) {
            $this->db->order_by($order, $dir);
        } else {
            $this->db->order_by('id', 'desc');
    ...
    //new query specific owner pets
    function getOwnerPatientByLimit($limit, $start, $order, $dir, $owner_id) {
        if ($order != null) {
            $this->db->order_by($order, $dir);
        } else {
            $this->db->order_by('id', 'desc');
    ...
    //new query for owner pets
    function getOwnerPatientByLimitBySearch($limit, $start, $search, $order, $dir, $owner_id) {
    ...
    function getPatientByOwnerId($id) {
