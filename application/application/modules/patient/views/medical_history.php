...
<section id="main-content">
    <section class="wrapper site-min-height">
            ...
            <aside class="profile-nav">
                <section class="">
                    <div class="user-heading round edit_patient_div">
                        ...
                        <p> <strong><?php echo $patient->bloodgroup; ?></strong> </p>
                    ...
                    <?php $owner_details = $this->owner_model->getOwnerById($patient->owner); ?>
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li> <?php echo lang('owner'); ?><span class="label pull-right r-activity"><?php echo $owner_details->name; ?></span></li>
                        <li> <?php echo lang('phone'); ?><span class="label pull-right r-activity"><?php echo $owner_details->phone; ?></span></li>
                        <li> <?php echo lang('nid'); ?><span class="label pull-right r-activity"><?php echo $owner_details->nid; ?></span></li>
        ...
        <section class="col-md-9">
            <header class="panel-heading clearfix">
                <div class="col-md-9">
                    <?php echo lang('treatment'); ?> | <?php echo $patient->name; ?>
                </div>
                <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                    <div class="col-md-3">
            ...
            <section class="panel-body">
                <header class="panel-heading tab-bg-dark-navy-blueee">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="">
                            <a data-toggle="tab" href="#vital"><?php echo lang('vital_signs'); ?></a>
                        </li>
                        ...
                        <?php if (!$this->ion_auth->in_group(array('Patient'))) {
                            if ($settings->show_odontogram_in_history == 'yes') { ?>
                                <li class="">
                                    <a data-toggle="tab" href="#odontogram"><?php echo lang('odontogram'); ?></a>
                                </li>
                        <?php }
                        } ?>
                    ...
                    <div class="tab-content">
                        <div id="vital" class="tab-pane">
                            <div class="">
                                ...
                                <?php if (!$this->ion_auth->in_group(array('Patient','Owner'))) { ?>
                                    <div class=" no-print">
                                        <a class="btn btn-info btn_width btn-xs" data-toggle="modal" href="#myModalVital">
                        ...
                        <?php if (!$this->ion_auth->in_group(array('Patient'))) {
                            if ($settings->show_odontogram_in_history == 'yes') { ?>
                                <div id="odontogram" class="tab-pane">
                                    <div class="">
                                            ...
                                            <?php foreach ($prescriptions as $prescription) { ?>
                                                <tr class="">
                                                    ...
                                                    <td class="no-print prescription_button">
                                                        ...
                                                        ?>
                                                        <a class="btn-xs  btn invoicebutton" title="<?php echo lang('print'); ?>" href="prescription/viewPrescriptionPrint?id=<?php echo $prescription->id; ?>" target="_blank"> <i class="fa fa-print"></i> <?php echo lang('print'); ?></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                        ...
                        <div id="lab" class="tab-pane">
                            ...
                            <?php if ($this->ion_auth->in_group(array('Doctor','admin'))) { ?>
                                <div class=" no-print">
                                                <a class="btn btn-info btn_width btn-xs" href="Lab/addLabView">
                                                    <i class="fa fa-plus-circle"> </i> <?php echo lang('add_new'); ?>
                                                </a>
                                            </div> 
                                <?php }  else { ?>
                        ...
                        <div id="profile" class="tab-pane">
                            <div class="">
                                ...
                                <div class=" add_folder_css">
                                    <!-- <div class="btn-group pull-right">
                                        <a class="btn btn-info btn_width btn-xs" data-toggle="modal" href="#myModalf">
                                                ...
                                                <div class="panel col-md-3 patient_material_class1">
                                                    ...
                                                    <div class="col-md-7 pull-right patient_material_url">
                                                        ...
                                                        <div class="post-info">
                                                            ...
                                                            <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                                                                <a class="btn btn-info btn-xs btn_width delete_button " title="<?php echo lang('delete'); ?>" href="patient/deletePatientMaterial?id=<?php echo $patient_material->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"> <i class="fa fa-trash"></i> </a>
                                                            <?php } ?>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div id="contact" class="tab-pane">
                            <div class="">
                                <?php if ($this->ion_auth->in_group(array('Doctor','admin'))) { ?>
                                    <div class=" no-print">
                                        <a class="btn btn-info btn_width btn-xs" data-toggle="modal" href="bed/bedAllotment">
                                            <i class="fa fa-plus-circle"> </i> <?php echo lang('add_new'); ?>
                                        </a>
                                    </div>
                                <?php }  else { ?>
...
<div class="modal fade" id="myModalVital" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"> <?php echo lang('add'); ?> <?php echo lang('vital_sign'); ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" action="patient/addNewVitalSign" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"> <?php echo lang('systolic_blood_pressure'); ?>&ast; </label>
                        <input min="1" type="number" class="form-control" name="systolic_blood_pressure" placeholder="" required="">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"> <?php echo lang('diastolic_blood_pressure'); ?>&ast; </label>
...
<!-- Add Patient Material Modal-->
<div class="modal fade" id="myModalVitalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"> <?php echo lang('edit'); ?> <?php echo lang('vital_sign'); ?></h4>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-body">
                <form role="form" action="patient/addNewFolder" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="folder_name" id="exampleInputEmail1" placeholder="">
                    </div>
                    <input type="hidden" name="patient" value='<?php echo $patient->id; ?>'>
                    <div class="form-group">
                        <button type="submit" name="submit" class="btn btn-info pull-right"> <?php echo lang('submit'); ?></button>
        ...
        <div class="modal-body">
            <form role="form" action="appointment/addNew" id="addAppointmentForm" class="clearfix row" method="post" enctype="multipart/form-data">
                <div class="col-md-4 panel">
                    ...
                    <?php if (!$this->ion_auth->in_group(array('Patient'))) { 
                         $pet_id = $patient->id;
                         $patient_info = $this->db->get_where('patient', array('id' => $pet_id))->row();
                         $owner_info = $this->db->get_where('owner', array('id' => $patient_info->owner))->row();
                        ?>
                       ...
                       <span class="form-control"><?php echo $owner_info->name; ?></span>
                        ...
                        <input type="hidden" class="form-control"  name="owner" value="<?php echo $patient_info->owner; ?>">
                    <?php } else {
