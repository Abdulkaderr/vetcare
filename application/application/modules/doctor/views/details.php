                                            ...
                                            ?>
                                                    <tr class="">
                                                        ...
                                                        <td class="no-print">
                                                            ...
                                                            <a class="btn btn-info btn-xs btn_width green button_his" title="<?php echo lang('treatment'); ?>" href="patient/medicalHistory?id=<?php echo $todays_appointment->patient; ?>"><i class="fa fa-stethoscope"></i> <?php echo lang('patient'); ?> <?php echo lang('treatment'); ?></a>
                                        ...
                                        <table class="table table-striped table-hover table-bordered patient_datatable" id="editable-sample">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($appointment_patients as $appointment_patient) {
                                                    ...
                                                    $owner_details = $this->owner_model->getOwnerById($appointed_patient->owner)
                                                ?>
                                                    <tr class="">

                                                        <td><?php echo $appointed_patient->id; ?></td>
                                                        <!-- <td><?php echo $appointed_patient->blood_group; ?></td> -->
                                                        <td><?php echo $owner_details->name; ?></td>
                                                        <td><?php echo $owner_details->phone; ?></td>
                                                        <td><?php echo $owner_details->nid; ?></td>
                                                        <td class="no-print">
                                                            <a class="btn green button_his" title="<?php echo lang('treatment'); ?>" href="patient/medicalHistory?id=<?php echo $appointed_patient->id; ?>"><i class="fa fa-stethoscope"></i> <?php echo lang('treatment'); ?></a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
            ...
            <div class="modal-body">
                <form role="form" action="appointment/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                    <div class="col-md-4 panel">
                        ...
                        <select class="form-control m-bot15  pos_select" id="pos_select" name="owner" value='' required="">
                    ...
                    <div class="pos_client clearfix">
                        ...
                        <div class="col-md-8 payment pad_bot pull-right">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control pay_in" name="p_nid" value='' placeholder="">
                            </div>
                        </div>
                        <!-- <div class="col-md-8 payment pad_bot pull-right">
                            <div class="col-md-3 payment_label">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editAppointmentForm" action="appointment/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                    <div class="col-md-4 panel">
                        <label for="exampleInputEmail1"> <?php echo lang('owner'); ?> &#42;</label>
                        <select class="form-control m-bot15  pos_select1 patient" id="pos_select1" name="owner" value='' required="">
