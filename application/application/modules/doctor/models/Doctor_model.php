...
class Doctor_model extends CI_model {
    ...
    function getDoctor($location_search='',$doctor_search='') 
    {
        $this->db->select('id,img_url,name,email,address,phone,department,profile,x,y,ion_user_id,department_name,appointment_confirmation,
        doctor_visit,visit_price');
        $this->db->from('doctor');
if(!empty($doctor_search)){
            $this->db->like('name',$doctor_search);

}
if(!empty($location_search)){

        $this->db->like('address',$location_search);
}
