...
****************** -->
		...
		<section class="section section-doctor">
			<div class="container-fluid">
				...
				<a  href="frontend/addlostpets">
					<div class="btn-group pull-right">
						<button class="btn green btn-xs">
							<i class="fa fa-plus-circle"></i> <?php echo 'Add lost Pet Information' ?>
						</button>
					</div>
				</a>

  <?php foreach ($lostpets as $lpet) { ?>
    <div class="col-lg-4 col-md-6 col-sm-12">
      <div class="profile-widget">
	  	<div class="doc-img">
          <a href="">
            <img class="img-fluid" alt="User Image" style="width: 370px;height: 246px;"
			 src="<?php if(!empty($lpet->pet_img)) { echo $lpet->pet_img;}else{ echo 'petcare/assets/img/lab-image.jpg';} ?>">
          </a>
        ...
        <div class="pro-content">
          <h3 class="title">
            <a href="">Pet No.: <?php echo $lpet->pet_num; ?></a>
          ...
          <ul class="available-info">
            <li><i class="fas fa-map-marker-alt"></i>  <?php echo $lpet->lost_location; ?></li>
			<li><i class="fas fa-clock"></i>  <?php echo $lpet->lost_date; ?></li>
			<li><i class="fa fa-transgender"></i>  <?php echo $lpet->pet_gender; ?></li>
			<li><i class="fa fa-paw"></i>  <?php echo $lpet->pet_strain; ?></li>
			<li>  <?php echo $lpet->pet_name; ?></li><br>
            <li> <i class=""></i> <?php echo $lpet->comments; ?><i data-bs-toggle="tooltip" ></i>
            </li>
          </ul>
          <!--<div class="row row-sm">
            <div class="col-6"> <a href="https://api.whatsapp.com/send?phone=<?php //echo $lpet->phone; ?>" class="btn book-btn">Whatsapp</a>
            </div>
          </div>-->
        </div>
      </div>
