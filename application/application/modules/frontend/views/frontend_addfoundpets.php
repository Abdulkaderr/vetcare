		...
		<section class="section section-doctor">
			<div class="container-fluid">
				<div class="section-header text-center">
					<h2>Add found pet information</h2>
				</div>
				...
				<form role="form" action="frontend/postaddfoundpet" class="clearfix" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for=""> Pet No. :</label>
                        <input type="text" class="form-control" name="pet_num" value=''>
                    </div>
                    <div class="form-group">
					...
					<div class="form-group">
                        <label>When did you find the pet? <span class="red">*</span></label>
                        <input class="form-control form-control-inline input-medium default-date-picker" type="text" name="found_date" placeholder="" required="" >
                    </div>
                    <div class="form-group">
                        <label for="">Where did you find the pet? <span class="red">*</span></label>
                        <input type="text" class="form-control" name="found_location" value='' placeholder="" required="">
                    </div>
                    <div class="form-group">
