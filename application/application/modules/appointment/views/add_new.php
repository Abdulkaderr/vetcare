                    ...
                    <div class="col-md-7">
                                ...
                                <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                                    <select class="form-control m-bot15  pos_select" id="pos_select" name="owner" value='' required>
                                        <?php if (!empty($appointment)) { ?>
                                            <option value="<?php echo $owners->id; ?>" selected="selected"><?php echo $owners->name; ?> - <?php echo $owners->id; ?></option>
                                        <?php } ?>
                                    </select>
                                <?php } else {
                                    $user = $this->ion_auth->get_user_id();
                                    $owners = $this->db->get_where('owner', array('ion_user_id' => $user))->row();
                                ?>
                                    <select class="form-control m-bot15  " id="" name="owner" value='' required>
                                        <option value="<?php echo $owners->id; ?>" selected="selected"><?php echo $owners->name; ?> - <?php echo $owners->id; ?></option>
                                    </select>
                                <?php } ?>
                            </div>
                        ...
                        <div class="pos_client clearfix">
                            ...
                            <div class="col-md-8 payment pad_bot pull-right">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control pay_in" name="p_nid" value='<?php
                                                                                                        if (!empty($payment->p_nid)) {
                                                                                                            echo $payment->p_nid;
                                                                                                        }
                                                                                                        ?>' placeholder="">
                                </div>
                            ...
                            <!-- <div class="col-md-8 payment pad_bot pull-right">
                                <div class="col-md-3 payment_label">
                                    <label for="exampleInputEmail1"> <?php echo lang('owner'); ?> <?php echo lang('gender'); ?></label>
                                </div>
                                <div class="col-md-9">
...
<script src="common/extranal/js/appointment/appointment_select2.js"></script>ent/edit_appointment.js"></script>
