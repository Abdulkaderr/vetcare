                            ...
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample1" >
                                        <thead>
                                            <tr>
                                            <th> <?php echo lang('number').' '.'appointment'; ?></th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="col-md-6 panel">
                        ...
                        <select class="form-control m-bot15 pos_select" id="pos_select" name="owner" value=''>
                    ...
                    <div class="col-md-6 panel doctor_div">
                        ...
                        <option value="<?php echo $doctors->id; ?>" selected="selected"><?php echo $doctors->name; ?></option>

                        </select>
                        <!-- <input type="" name="doctor" id="doctorchoose22" value="<?php echo $doctors->id; ?>"> -->
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="col-md-6 panel">
                        <label for="exampleInputEmail1"> <?php echo lang('owner'); ?></label>
                        <select class="form-control m-bot15  pos_select1 patient" id="pos_select1" name="owner" value=''>
