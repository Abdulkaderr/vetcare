                        ...
                        <form role="form" id="editLabForm" class="clearfix" action="lab/addLab" method="post" enctype="multipart/form-data">
                            ...
                            <div class="">
                                ...
                                <div class="col-md-6 lab pad_bot">
                                    ...
                                    <input type="hidden" name="doctor" id="add_doctor" value="<?php echo $doctors->id; ?>">

                                </div>

                                <div class="col-md-6 lab pad_bot">
                                    <label for="exampleInputEmail1">
                                        <?php echo lang('type').' '.('test lab'); ?>
                                    </label>
                            ...
                            <div class="col-md-12 lab pad_bot">
                                <label for="exampleInputEmail1"> <?php echo lang('Patient_Disposition'); ?></label>
