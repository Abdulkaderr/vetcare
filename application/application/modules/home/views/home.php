                                    ...
                                    if ($appointment->date == strtotime(date('Y-m-d'))) {
                                        ...
                                        <tr class="">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn detailsbutton" title="<?php lang('treatment') ?>"  href="patient/medicalHistory?id=<?php echo $appointment->patient ?>"><i class="fa fa-stethoscope"></i> <?php echo lang('treatment'); ?></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
