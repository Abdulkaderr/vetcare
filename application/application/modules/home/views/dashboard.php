        ...
        <header class="header white-bg">
            ...
            <div class="nav notify-row" id="top_menu">
                ...
                <ul class="nav top-menu">
                    ...
                    <!-- appointments notification start -->
                    <?php if ($this->ion_auth->in_group(array('admin', 'Doctor'))) { ?>
                        <li id="header_notification_bar" class="dropdown">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                ...
                                $query1 = $query1->row()->id;


                                    $this->db->where('doctor', $query1);
                                    ...
                                    if (!empty($app_number)) {
                                        echo $app_number = array_sum($app_number);
                                    } else {
                                        $app_number = 0;
                                        echo $app_number;
                                    }
                    ...
                    <?php } ?>
                    <!-- appointments notification end -->

                      <!--owner appointments notification start -->
                      <?php if ($this->ion_auth->in_group(array( 'Owner'))) { ?>
                        <li id="header_notification_bar" class="dropdown">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                ...
                                $username = $this->ion_auth->user()->row()->username;
                                $this->db->where('name', $username);
                                $query1 = $this->db->get('owner');
                                $query1 = $query1->row()->id;


                                    $this->db->where('owner', $query1);
                    ...
                    <?php } ?>
                    <!-- owner appointments notification end -->
                    ...
                    <?php if ($this->ion_auth->in_group(array('Laboratorist', 'Nurse'))) { ?>
                        <li id="header_notification_bar" class="dropdown">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
            ...
            <div id="sidebar" class="nav-collapse">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <?php if ($this->ion_auth->in_group(array(  'Doctor'))) { ?>
                        <li><a href="doctor/details"><i class="fa fa-user"></i><?php echo lang('patient'); ?></a></li>
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Nurse', 'Doctor', 'Laboratorist', 'Receptionist', 'Owner'))) { ?>
                        ...
                        <?php if (!$this->ion_auth->in_group(array('Owner'))) { ?>
                            <li><a href="owner"><i class="fa fa-user"></i><?php echo lang('owner'); ?></a></li>
                        <?php } ?>

                        <?php if ($this->ion_auth->in_group(array('Doctor'))) { ?>
                            <li><a href="owner/myowners"><i class="fa fa-user"></i><?php echo lang('my_owners'); ?></a></li>
                        <?php } ?>


                    <?php } ?>

                    <?php if ($this->ion_auth->in_group(array('Owner','Doctor'))) { ?>
                    ...
                    <?php if ($this->ion_auth->in_group(array('Owner'))) { ?>
                        <li><a href="appointment/myTodays"><i class="fa fa-headphones"></i><?php echo lang('my'); ?> <?php echo lang('appointment'); ?></a></li>
...
<!-- 
                    ...
                    <?php //if ($this->ion_auth->in_group(array('admin','Doctor'))) { ?>
                        <!--<li class="sub-menu">
                            ...
                            <ul class="sub">
                            <li><a href="bed/bedAllotment"><i class="fas fa-bed"></i><?php echo lang('bed_list'); ?></a></li>-->

                                <!-- <li><a href="bed"><i class="fa fa-syringe"></i><?php echo lang('bed_list'); ?></a></li> -->
                    ...
                    <!--new sidebar list-->
                    <?php if ($this->ion_auth->in_group(array('admin','Doctor','Laboratorist'))) { ?>
                        <li><a href="home/newrecord"><i class="fa fa-file-medical"></i><?php echo lang('newrecord'); ?></a></li>
                    <?php } ?>
                    <!--//-->
                    ...
                    <?php } ?>
                    <?php if ($this->ion_auth->in_group(array('Accountant', 'Receptionist', 'Nurse', 'Laboratorist', 'Pharmacist'))) { ?>
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin', 'Owner'))) { ?>
                        <li class="sub-menu">
                            <a href="javascript:;">
                                <i class="fa fa-bells"></i>
                                <span><?php echo lang('missing_posts'); ?></span>
                            </a>
                            <ul class="sub">
                                <li><a href="missingpet"><i class="fa fa-bells"></i><?php echo lang('all'); ?> <?php echo lang('missing_pets'); ?></a></li>
                                <li><a href="missingpet/addNewView"><i class="fa fa-list-alt"></i><?php echo lang('add_post'); ?></a></li>
                            </ul>
                        </li>
                    <?php } ?>
                    <?php if ($this->ion_auth->in_group(array('admin', 'Owner'))) { ?>
                        <li class="sub-menu">
                            <a href="javascript:;">
                                <i class="fa fa-bells"></i>
                                <span><?php echo lang('mating_posts'); ?></span>
                            </a>
                            <ul class="sub">
                                <li><a href="matingpet"><i class="fa fa-bells"></i><?php echo lang('all'); ?> <?php echo lang('mating_pets'); ?></a></li>
                                <li><a href="matingpet/addNewView"><i class="fa fa-list-alt"></i><?php echo lang('add_post'); ?></a></li>
                            </ul>
                        </li>
                    <?php } ?>
                    ...
                    <?php } ?>
                    <?php if ($this->ion_auth->in_group(array('Receptionist', 'Accountant'))) { ?>
                        <li>
                            <a href="bed/addAllotmentView">
                                <i class="fa fa-tasks"></i>
                                <span> <?php echo lang('add_allotment'); ?> </span>
                            </a>
                        </li>
                        <li>
                            <a href="bed/bedAllotment">
                    ...
                    <?php if ($this->ion_auth->in_group(array('admin','Owner', 'Doctor'))) { ?>
                        <li class="sub-menu">
                            <a href="javascript:;">
                                <i class="fa fa-paw"></i>
                            ...
                            <ul class="sub">
                                <li><a href="lostpets"><i class="fa fa-list-alt"></i>All Lost Pets</a></li>
                                <li><a href="foundpets"><i class="fa fa-list-alt"></i>All Found Pets</a></li>
                            </ul>
                        </li>
                    <?php } ?>
