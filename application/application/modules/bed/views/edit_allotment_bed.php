            ...
            <section class="panel-body">
                <header class="panel-heading tab-bg-dark-navy-blueee">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a data-toggle="tab" href="#checkin"><?php echo lang('edit'); ?></a>
                        </li>
                        <!-- <li class="">
                ...
                <div class="panel">
                    <div class="tab-content">
                        <div id="checkin" class="tab-pane active">
                            <div class="">
                                <form role="form" action="bed/addAllotment" id="editBedAllotment" class="clearfix" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="bed_id" id="bed_id" value='<?php echo $allotment->bed_id; ?>' placeholder="" required="">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="description" value='<?php echo $allotment->category_status; ?>' placeholder="" required="">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="a_time"><?php echo lang('current_date') . ' '; ?> &#42;</label>
                                        <input type="date" class="form-control" name="a_time" value='<?php echo $allotment->a_time; ?>' placeholder="" required="">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="d_time"><?php echo lang('next_due_date') . ' '; ?> &#42;</label>
                                        <input type="date" class="form-control" name="d_time" value='<?php echo $allotment->d_time; ?>' placeholder="" required="">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="status"><?php echo lang('weight') . ' '; ?> &#42;</label>
                                        <input type="text" class="form-control" name="status" value='<?php echo $allotment->status; ?>' placeholder="" required="">
                                    </div>
