                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang('Serial Number').' '  ;echo lang('Manufacturer'); ?></th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="bed/addBed" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                        <label for="description"><?php echo lang('Serial Number').' ';echo lang('Manufacturer'); ?> &#42;</label>
                        <input type="text" class="form-control" name="description"  value='' placeholder="" required="">
                    </div>

                    <div class="form-group col-md-12">
                        <label for="last_a_time"><?php echo lang('current_date').' '; ?> &#42;</label>
                        <input type="date" class="form-control" name="last_a_time"  value='' placeholder="" required="">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="last_d_time"><?php echo lang('next_due_date').' '; ?> &#42;</label>
                        <input type="date" class="form-control" name="last_d_time"  value='' placeholder="" required="">
                    </div>
                    <div class="form-group col-md-12">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editBedForm" class="clearfix row" action="bed/addBed" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1"><?php echo lang('bed_number '); echo lang('Manufacturer') ?> &#42;</label>
                        <input type="text" class="form-control" name="number"  value='' placeholder="" required="">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="description"><?php echo lang('Serial Number').' ';echo lang('Manufacturer'); ?> &#42;</label>
                    ...
                    <div class="form-group col-md-12">
                        <label for="last_a_time"><?php echo lang('current_date').' '; ?> &#42;</label>
                        <input type="text" class="form-control" name="last_a_time"  value='' placeholder="" required="">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="last_d_time"><?php echo lang('next_due_date').' '; ?> &#42;</label>
                        <input type="text" class="form-control" name="last_d_time"  value='' placeholder="" required="">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="status"><?php echo lang('weight').' '; ?> &#42;</label>
                        <input type="text" class="form-control" name="status"  value='' placeholder="" required="">
