...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"> <?php echo lang('edit_missingpet'); ?></h4>
            </div>
            <div class="modal-body row">
                <form role="form" id="editMissingpetForm" class="clearfix" action="missingpet/addMissingpet" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="addMissingpetDepositForm" action="finance/missingpetDeposit" id="deposit-form" class="clearfix" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('missingpet'); ?> <?php echo lang('id'); ?></label>
                        <input type="text" class="form-control" name="missingpet_id" value='' placeholder="" readonly>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('missingpet'); ?> <?php echo lang('name'); ?></label>
                        <input type="text" class="form-control" name="missingpet_name" value='' placeholder="" readonly>
                    </div>
                    <div class="form-group">
...
<script src="common/extranal/js/missingpet.js"></script>