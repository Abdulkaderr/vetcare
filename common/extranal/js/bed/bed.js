    ...
    $(".table").on("click", ".editbutton", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#editBedForm').find('[name="last_a_time"]').val(response.bed.last_a_time).end()
                $('#editBedForm').find('[name="last_d_time"]').val(response.bed.last_d_time).end()
                $('#editBedForm').find('[name="status"]').val(response.bed.status).end()
            }
        })
    });
});
